   ...
   desc: "Toggles doubletime filter!",
    ...
    run: async ({ client, message, emojis, player, args }) => {
        ...
        const embed = new EmbedBuilder()
            .setDescription(`<a:dch_catheart:1071384664083808346> **Double Time Filter**`)
            ...
            message.channel.send({ embeds: [embed], components: [row] }).then(async msg => {
                ...
                const embed = new EmbedBuilder()
                    .setDescription(`<:serverinforight:1026436118192848906> | **Double Time Filter Turned On**`)
                    .setColor(client.settings.COLOR)
                ...
                player.send(data);
                const embed = new EmbedBuilder()
                    .setDescription(`<:serverinforight:1026436118192848906> | **Double Time Filter Turned Off**`)
                    .setColor(client.settings.COLOR)
                message.channel.send({ embeds: [embed] });
                msg.delete();
            }
