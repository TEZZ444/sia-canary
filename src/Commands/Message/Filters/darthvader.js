  ...
  run: async ({ client, message, emojis, player, args }) => {
    try {
      ...
      const embed = new EmbedBuilder()
        .setDescription(
          `<a:dch_catheart:1071384664083808346> **Darth Vader Filter**`
        )
        ...
        .then(async (msg) => {
          ...
          collector.on("collect", async (i) => {
            if (i.customId === "on") {
              ...
              const embed = new EmbedBuilder()
                .setDescription(
                  `<:serverinforight:1026436118192848906> | **Darth Vader Filter Turned On**`
                )
                .setColor(client.settings.COLOR);
              ...
              const embed = new EmbedBuilder()
                .setDescription(
                  `<:serverinforight:1026436118192848906> | **Darth Vader Filter Turned Off**`
                )
                .setColor(client.settings.COLOR);
              message.channel.send({ embeds: [embed] });
              msg.delete();
